...
function cleanupChallengeState(): void {
  isOpen.value = false
  currentPromise = null
  settleCurrent = null
}
...
export function setClientChallengeSiteKey(siteKey?: string | null): void {
...
export function resolveClientChallenge(): void {
  settleCurrent?.(true)
  cleanupChallengeState()
}

export function dismissClientChallenge(): void {
  settleCurrent?.(false)
  cleanupChallengeState()
}
