    ...
    <MainLayout>
        <div class="search-page">
            ...
            <div class="search-tabs glass-card">
                <button type="button" :class="['tab-button', { active: activeTab === 'posts' }]"
            ...
            <section v-else class="search-results-wrapper">
                ...
                <div v-else class="results-section glass-card">
                    ...
                    <div v-else-if="authors.length > 0" class="results-list authors-list">
                        ...
                        <Pagination v-if="authorsTotalPages > 1" :current-page="authorsPage"
                            :total-pages="authorsTotalPages" @change="handleAuthorsPageChange" />
                    </div>
...
const activeTab = ref<'posts' | 'authors'>(
    route.query.tab === 'authors' ? 'authors' : 'posts',
)
const query = ref<string>(
    typeof route.query.q === 'string' ? route.query.q : Array.isArray(route.query.q) ? route.query.q[0] || '' : '',
)
