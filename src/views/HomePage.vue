...
const homePreviewHighlights: HmrCommunityItem[] = [
  ...
  },
  {
    ...
    excerpt: '接口恢复后，新的互动摘要会在同一组卡片里呈现。',
    metric: '继续',
    target: '/community',
  },
  {
    ...
    excerpt: '深色分区持续承载公开社区信号，空数据时也保留完整浏览结构。',
    metric: '公开',
    target: '/community',
  },
]
...
const homePreviewSchedule: HmrScheduleItem[] = [
  {
    ...
    phase: '直播',
    time: '20:30',
    description: '当日重点时间持续显示在首页工作区，预览与实时内容沿用同一结构。',
  },
  {
...
const homePreviewFeaturedPosts: HmrPost[] = [
  ...
  },
  {
    ...
    title: '空数据时依然保留完整首页结构',
    excerpt: '实时内容暂不可用时，首屏之后的浏览节奏仍保持完整。',
    tag: '结构',
    createdAt: '稳定',
    statsLabel: '入口',
  },
