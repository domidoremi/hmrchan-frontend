...
- Simplified Chinese documentation lives in the root `README.md` and `docs/zh-CN/`
- English documentation lives in `docs/en/`
- Code comments use English
- Comments record non-obvious constraints, failure semantics, and compatibility reasons
- Clear control flow and descriptive names do not receive narration comments
- User-visible copy stays in the i18n catalog
