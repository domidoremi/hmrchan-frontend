...
const GUEST_BROWSER_ROUTE_DEFINITIONS = Object.freeze(
  [
    ...
    },
    {
      ...
      path: '/schedule',
      mode: 'guest',
      shellSelector: '.hmr-route-page--schedule',
    },
    {
      name: 'settings route',
      path: '/settings',
      mode: 'guest',
      shellSelector: '.hmr-route-page--settings',
    },
    { name: 'login route', path: '/login', mode: 'guest', shellSelector: '.hmr-auth-page' },
    { name: 'register route', path: '/register', mode: 'guest', shellSelector: '.hmr-auth-page' },
    {
      name: 'auth callback route',
      path: '/auth/callback',
      mode: 'guest',
      shellSelector: '.hmr-auth-callback',
    },
    {
      name: 'passkey recovery route',
      path: '/auth/passkey-recovery',
      mode: 'guest',
      shellSelector: '.hmr-auth-page',
    },
    {
      name: 'legacy passkey recovery redirect',
      path: '/passkey-recovery',
      mode: 'guest',
      shellSelector: '.hmr-auth-page',
      expectedPath: '/auth/passkey-recovery',
      expectedCanonicalPath: '/auth/passkey-recovery',
    },
    {
      name: 'about route',
      path: '/about',
      mode: 'guest',
      shellSelector: '.hmr-route-page--about',
    },
    {
      name: 'contact route',
      path: '/contact',
      mode: 'guest',
      shellSelector: '.hmr-route-page--contact',
    },
    {
      name: 'join route',
      path: '/join-us',
      mode: 'guest',
      shellSelector: '.hmr-route-page--join',
    },
    {
  ...
  [
    {
      ...
      mode: 'auth',
      sectionId: 'overview',
      shellSelector: buildProfileSectionShellSelector('overview'),
      expectedTitleKey: 'nav.profile',
      readinessSelectorsAll: ['[data-testid="profile-overview-tab"]'],
