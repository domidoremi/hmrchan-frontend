...
- **PUT /api/v1/discussions/comments/{comment_id}** — 编辑评论
  ...
  - 成功响应：
    - 200 JSON -> data:DiscussionCommentResponse
      - data 字段结构：- `id` (type:integer; required:yes) - `uuid` (type:string; required:yes) - `content` (type:string; required:yes) - `user` (type:object; required:yes) - `discussion_id` (type:integer; required:yes) - `parent_id` (type:integer|null; required:no) - `like_count` (type:integer; required:yes) - `reply_count` (type:integer; required:yes) - `is_liked` (type:boolean; required:no) - `created_at` (type:string; required:yes) - `updated_at` (type:null|string; required:no)
